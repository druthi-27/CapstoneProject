...
const AboutInfo = () => {
  return (
    <section className="about py-5">
        <img  className="about__image" src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/harder-jett-008-1643379018.jpg?crop=1.00xw:0.749xh;0.00160xw,0.115xh&resize=480:*" alt=""></img>
